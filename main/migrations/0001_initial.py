...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('main', ['Wall'])
        ...
        db.create_table('main_message', (
            ...
            ('twitter_account', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('wall', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Wall'])),
        ))
