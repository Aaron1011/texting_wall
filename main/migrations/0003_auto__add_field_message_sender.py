...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_message', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.MessageSender'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'main.wall': {
            ...
            'hashtag': ('django.db.models.fields.CharField', [], {'default': "'woy'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
