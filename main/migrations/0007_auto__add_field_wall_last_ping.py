...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wall.last_ping'
        db.add_column('main_wall', 'last_ping',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wall.last_ping'
        db.delete_column('main_wall', 'last_ping')
    ...
    models = {
        ...
        'main.wall': {
            ...
            'hashtag': ('django.db.models.fields.CharField', [], {'default': "'jse'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
