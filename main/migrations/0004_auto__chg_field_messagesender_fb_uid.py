...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessageSender.fb_uid'
        db.alter_column('main_messagesender', 'fb_uid', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MessageSender.fb_uid'
        raise RuntimeError("Cannot reverse this migration. 'MessageSender.fb_uid' and its values cannot be restored.")
    ...
    models = {
        ...
        'main.wall': {
            ...
            'hashtag': ('django.db.models.fields.CharField', [], {'default': "'ygv'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
