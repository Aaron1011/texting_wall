...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MessageSender.image_url'
        db.delete_column('main_messagesender', 'image_url')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MessageSender.image_url'
        raise RuntimeError("Cannot reverse this migration. 'MessageSender.image_url' and its values cannot be restored.")
    ...
    models = {
        ...
        'main.wall': {
            ...
            'hashtag': ('django.db.models.fields.CharField', [], {'default': "'zcq'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
