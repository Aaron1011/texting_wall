...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageSender.image'
        db.add_column('main_messagesender', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageSender.image'
        db.delete_column('main_messagesender', 'image')
    ...
    models = {
        ...
        'main.wall': {
            ...
            'hashtag': ('django.db.models.fields.CharField', [], {'default': "'wmo'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
